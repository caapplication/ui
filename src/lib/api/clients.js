import { getAuthHeaders, handleResponse } from './utils';
    ...
    const TASK_API_BASE_URL = 'http://localhost:8004';
    const CLIENTS_API_BASE_URL = 'http://localhost:8002';
    const SERVICES_API_BASE_URL = 'http://localhost:8004';
    const LOGIN_API_BASE_URL = 'http://localhost:8001';
