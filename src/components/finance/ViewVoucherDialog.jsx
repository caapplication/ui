...
const ViewVoucherDialog = ({ voucher, fromAccount, toAccount, beneficiary, isOpen, onOpenChange, organizationName }) => {
    ...
    const handleExportPDF = () => {
        ...
        const beneficiaryInfo = [
            [{ content: 'Paid to:', styles: { fontStyle: 'bold' } }, beneficiaryDetails.name || 'N/A'],
    ...
    const displayBeneficiaryName = beneficiary?.beneficiary_type === 'individual' ? beneficiary?.name : beneficiary?.company_name;
            ...
            <DialogContent className="glass-pane text-white">
                ...
                <div className="grid gap-4 py-4 text-sm">
                    <div className="grid grid-cols-2 gap-2">
                        ...
                        <p>{displayBeneficiaryName || 'Unknown Beneficiary'}</p>
                    </div>
                     <div className="grid grid-cols-2 gap-2">
